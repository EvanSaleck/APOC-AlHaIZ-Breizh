<?php
    ...
    class Reservation {
        ...
        public function getReservationsForExportICal($dateDeb, $dateFin, $listeLogements) {
            ...
            $reservations = $this->db->executeQuery("SELECT r.id_reservation, r.date_arrivee, r.date_depart, r.tarif_total, c.pseudo, c.email, l.titre, a.adresse, a.code_postal, a.ville 
