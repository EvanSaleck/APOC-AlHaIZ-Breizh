...
function SetModalAndProfilePicture() { // Pass currentUser as an argument
    ...
    if (currentUser === null) {
      ...
      compte.style.backgroundImage = `url('${currentUser.url}')`;
    }
}
...
function ShowModalConnexion() {
  ...
  connexion.innerHTML = `<p>Se Connecter/ s'inscrire</p><svg width="35" height="35" viewBox="0 0 55 46" fill="none" xmlns="http://www.w3.org/2000/svg">
